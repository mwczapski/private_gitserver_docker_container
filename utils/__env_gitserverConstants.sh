...
readonly __GITSERVER_MAPPED_PORTS="--publish=${__GIT_HOST_PORT}:${_GIT_GUEST_PORT_}/tcp"
         __GITSERVER_PORT_MAPPINGS[0]="${__GIT_HOST_PORT}:${_GIT_GUEST_PORT_}/tcp"  # can't be readonly - gives exception
